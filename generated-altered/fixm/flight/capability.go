...
type CommunicationCapabilitiesType struct {
	...
	Extension	[]*CommunicationCapabilitiesExtensionType	`xml:"extension"`
...
type DinghiesType struct {
	...
	Extension	[]*DinghiesExtensionType	`xml:"extension"`
	Number	*CountType	`xml:"number"`
...
type FlightCapabilitiesType struct {
	...
	Extension	[]*FlightCapabilitiesExtensionType	`xml:"extension"`
...
type NavigationCapabilitiesType struct {
	Extension	[]*NavigationCapabilitiesExtensionType	`xml:"extension"`
	...
	RequiredRunwayVisualRange	*DistanceType	`xml:"requiredRunwayVisualRange"`
}

// SurveillanceCapabilitiesType ...
type SurveillanceCapabilitiesType struct {
	Extension	[]*SurveillanceCapabilitiesExtensionType	`xml:"extension"`
...
type SurvivalCapabilitiesType struct {
	...
	Extension	[]*SurvivalCapabilitiesExtensionType	`xml:"extension"`
