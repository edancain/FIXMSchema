...
// Specifies whether the boundary crossing occurs at or above or at or below the...
...
// An altitude (flight level) at or above/below which (specified in Boundary Cro...
type AltitudeInTransitionType struct {
	// Specifies whether the boundary crossing occurs at or above or at or below the...
	CrossingCondition *flight.BoundaryCrossingConditionType `xml:"crossingCondition"`
...
// Boundary Crossing contains estimate data conveyed between ATS Units during th...
type BoundaryCrossingType struct {
	// Negotiated boundary crossing transition altitude.
	AltitudeInTransition *flight.AltitudeInTransitionType `xml:"altitudeInTransition"`
	// The cleared altitude (flight level) at which the aircraft will cross the boun...
	...
	// The estimated time at which a flight will cross the associated boundary cross...
...
type EnRouteType struct {
	// An ICAO designator of the aerodrome to which a flight could be diverted while...
	AlternateAerodrome []base.AerodromeReferenceType `xml:"alternateAerodrome"`
	// A proposed boundary crossing information with associated details including al...
	BoundaryCrossingCoordination *flight.BoundaryCrossingType `xml:"boundaryCrossingCoordination"`
