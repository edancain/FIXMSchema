...
type SpecialHandlingReasonCodeListType []SpecialHandlingReasonCodeType
...
type FlightType struct {
	...
	Aircraft *aircraft.AircraftType `xml:"aircraft"`
	...
	Emergency *emergency.FlightEmergencyType `xml:"emergency"`
	// Groups the en route information about the flight.
	EnRoute *enroute.EnRouteType `xml:"enRoute"`
	...
	FlightConstraint []FlightConstraintType `xml:"flightConstraint"`
	// A container of flight identifying data. [FIXM]
	FlightIdentification *FlightIdentificationType `xml:"flightIdentification"`
	...
	// The category of flight rules with which the pilot intends to comply. [ICAO Doc 4444, Appendix 2, Item 8]
	FlightRulesCategory *FlightRulesCategoryType `xml:"flightRulesCategory"`
	// Indication of the rule under which an air traffic controller provides categorical handling of a flight. [FIXM]
	FlightType *TypeOfFlightType `xml:"flightType"`
	...
	RadioCommunicationFailure *emergency.RadioCommunicationFailureType `xml:"radioCommunicationFailure"`
	...
	RouteTrajectoryGroup *RouteTrajectoryGroupContainerType `xml:"routeTrajectoryGroup"`
	// The reason for special handling of a flight by ATS. [adapted from ICAO Doc 4444, Appendix 2, ITEM 18 STS/]
	SpecialHandling *SpecialHandlingReasonCodeListType `xml:"specialHandling"`
	...
	SupplementaryInformation *SupplementaryInformationType `xml:"supplementaryInformation"`
}
...
type FlightIdentificationType struct {
	...
	IataFlightDesignator *IataFlightDesignatorType `xml:"iataFlightDesignator"`
...
type IataFlightDesignatorType struct {
	...
	// Up to four-digit commercial flight number. [FIXM]
	FlightNumber *FlightNumberType `xml:"flightNumber"`
	// IATA identifier for the operator of the flight. [FIXM]
	IataOperatorCode *IataOperatorCodeType `xml:"iataOperatorCode"`
	// One character suffix used to further identify a flight. [FIXM]
	OperationalSuffix *OperationalSuffixType `xml:"operationalSuffix"`
}
...
type SupplementaryInformationType struct {
	...
	SupplementaryInformationSource *SupplementaryInformationSourceChoiceType `xml:"supplementaryInformationSource"`
}
